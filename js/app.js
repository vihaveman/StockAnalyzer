...
//   let myValue =  d3.select('#selDataset').value
// anychart.data.loadJsonFile(`https://www.alphavantage.co/query?function=${myValue}&symbol=IBM&interval=5min&apikey=demo`,  
// anychart.data.loadJsonFile(`https://www.alphavantage.co/query?function=${myValue}&symbol=IBM&interval=5min&apikey=demo`,  
// function (data) {
